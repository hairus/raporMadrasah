...
//     Route::post('/admin/saveTa', 'AdminController@saveTa');
//     Route::get('/admin/aktifTa/{id}', 'AdminController@aktifTa');
//     Route::get('/admin/KelasSiswa', 'AdminController@KelasSiswa');
//     Route::get('/admin/KelasSiswa/{id}', 'AdminController@KelasSiswaId');
//     Route::get('/admin/kembaliKelas/{id}', 'AdminController@kembaliKelas');
//     Route::get('/admin/naikKelas/{id}', 'AdminController@naikKelas1');
//     Route::post('/admin/naikKelas/', 'AdminController@naikKelas');
//     Route::get('/admin/hapusSiswa/{id}', 'AdminController@hapusSiswa');


//     /* penilaian */
//     Route::get('/admin/kelas', 'AdminController@kelas');
//     Route::post('admin/InputNilai', 'AdminController@inputNilai')->name('IN');
//     Route::get('admin/niperorang', 'AdminController@niperorang');
//     Route::post('admin/simpanNilaiPerorangan', 'AdminController@simpanNilaiPerorangan');
...
//     Route::put('/admin/upadmin/KelasSiswa/2date', 'AdminController@update');
...
//     Route::get('/admin/DelSiswa', 'AdminController@delSiswa');
//     Route::get('/admin/delSiswa/{kelas}', 'AdminController@showSiswa');
//     Route::post('/admin/delSis/fix', 'AdminController@deleteSiswa');
//     Route::post('/admin/delSis/fix', 'AdminController@deleteSiswa');
//     Route::get('/admin/addTa', 'AdminController@addTa');
...
//     /* cetak legger*/
//     Route::get('/admin/rapor/cetakLegger', 'AdminController@legger');
//     Route::get('/admin/rapor/showLegger/{kelas}', 'AdminController@showLegger');
//     /*---------------*/

//     /* settigan mapel kelas*/
//     Route::get('/admin/mapelKelas', 'AdminController@mapel_kelas');
//     Route::post('admin/saveMapel', 'AdminController@saveMapel');
//     Route::get('/admin/delMapelKelas/{id}', 'AdminController@delMapelKelas');
//     /*----------*/


//     /*--------- setingan untuk kwnaikan siswa ------------*/
//     Route::get('/admin/singkron', 'AdminController@singkron');
//     Route::get('/admin/addTgl', 'AdminController@addTgl');
//     Route::post('/admin/addTgl1', 'AdminController@addTgl1');

//     /*----------------------------------------------------*/

//     Route::get('/rapor/cetak', 'raporController@index');
//     Route::get('/admin/showSiswaEdit', 'raporController@showSiswaEdit')->name('siswaEdit');
//     Route::post('/admin/editBioSiswa', 'raporController@editBioSiswa');
//     Route::get('/admin/showBioSiswa1/{id}', 'raporController@showBioSiswa1');
//     Route::patch('/admin/updateBio', 'raporController@updateBio');
