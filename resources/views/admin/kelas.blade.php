...
@section('content')
    ...
    <div class="row">
        <div class="x_panel">
            ...
            <div class="x_content">
                <br>
                <form class="form-horizontal form-label-left" action="{{ route('IN') }}" method="post">
                    {{ csrf_field() }}
                    ...
                    <div class="form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12">Pilih Mapel</label>
                        <div class="col-md-9 col-sm-9 col-xs-12">
                            <select class="select2_single form-control" tabindex="-1" name="mapel">
                                <option>---</option>
